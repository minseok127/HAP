This repository archives the HAP module, extracted as a submodule of [LOCATOR](https://github.com/snu-dbxlab/LOCATOR) project. The module implements hidden attribute as described in the LOCATOR paper. The code is located in src/backend/hap, and modifications to existing PostgreSQL functions are marked with the HAP_HOOK keyword and #ifdef HAP.
