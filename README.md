...
This README explains implementation details of HAP. It is divided into four main categories: (1) creating HAP tables, (2) encoding hidden attribute, (3) retrieving encoded values during the insert process, (4) converting predicates on ancestor tables into predicates on hidden attributes in descendant tables.
