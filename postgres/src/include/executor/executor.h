...
#ifdef TEMP_IO
extern uint64_t qual_time_nsec;
extern uint64_t project_time_nsec;
#endif /* TEMP_IO */
...
ExecProject(ProjectionInfo *projInfo)
{
	...
	project_time_nsec += (end.tv_sec - start.tv_sec) * 1e9 + (end.tv_nsec - start.tv_nsec);
#endif /* TEMP_IO */
...
ExecQual(ExprState *state, ExprContext *econtext)
{
	...
	qual_time_nsec += (end.tv_sec - start.tv_sec) * 1e9 + (end.tv_nsec - start.tv_nsec);
#endif /* TEMP_IO */
