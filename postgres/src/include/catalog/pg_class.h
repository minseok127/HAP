...
CATALOG(pg_class,1259,RelationRelationId) BKI_BOOTSTRAP BKI_ROWTYPE_OID(83,RelationRelation_Rowtype_Id) BKI_SCHEMA_MACRO
{
	...
	/* HAP's partition map */
	Oid			relhappartmapid		BKI_DEFAULT(0);

	/* HAP's partition map index (hash) */
	Oid			relhappartmaphashid	BKI_DEFAULT(0);

	/* HAP's partition map index (gin) */
	Oid			relhappartmapginid		BKI_DEFAULT(0); 
