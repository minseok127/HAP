...
retry:
	...
	relation->rd_hap_partmap_id = relp->relhappartmapid;
	relation->rd_hap_partmap_hash_idx_id = relp->relhappartmaphashid;
	relation->rd_hap_partmap_gin_idx_id = relp->relhappartmapginid;
#endif /* HAP */
