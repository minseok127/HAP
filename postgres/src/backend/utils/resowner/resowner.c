...
#ifdef HAP_REDUCTION
static void PrintSubstitutionCacheLeakWarning(HapSubstitutionCache *cache);
#endif 
 ...
 */
static void
PrintSubstitutionCacheLeakWarning(HapSubstitutionCache *cache)
{
	elog(WARNING, "substitution cache leak: cache %d still referenced",
		 cache->cache_idx);
}
#endif /* HAP_REDUCTION */
